...
def set_template(args):
    ...
    args.dataset_code = dataset_code['1']
    ...
    args.class_num = 50 #最后一层IB输出维度，用来算mu，std等
    args.bert_hidden_units = 64 #bert的输出维度
    args.h_dim1 = 60 #第一层IB的输出维度，第二层IB的输入维度
    args.h_dim2 = 55 #第二层IB的输出维度
    args.h_dim3 = 50 #第三层IB的输出维度
...
##
# parser.add_argument('--defense_method', type=str, default='dirichlet')
# ##
...
##
# parser.add_argument('--attlabel', type=str, default='labels1.csv')
# parser.add_argument('--attseq', type=str, default='seqs.csv')
# ##
################
